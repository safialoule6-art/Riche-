...
(function () {
  ...
  var TIKTOK_ID = 'DXXXXXXXXXXXXXXXXXXXXX';
  ...
  if (ttOn) {
    !function (w, d, t) {
      w.TiktokAnalyticsObject = t; var ttq = w[t] = w[t] || []; ttq.methods = ["page", "track", "identify", "instances", "debug", "on", "off", "once", "ready", "alias", "group", "enableCookie", "disableCookie"], ttq.setAndDefer = function (t, e) { t[e] = function () { t.push([e].concat(Array.prototype.slice.call(arguments, 0))) } }; for (var i = 0; i < ttq.methods.length; i++)ttq.setAndDefer(ttq, ttq.methods[i]); ttq.instance = function (t) { for (var e = ttq._i[t] || [], n = 0; n < ttq.methods.length; n++)setAndDefer(e, ttq.methods[n]); return e }, ttq._i = {}, ttq._i[t] = [], ttq._i[t], ttq.load = function (e, n) { var i = "https://analytics.tiktok.com/i18n/pixel/events.js"; ttq._i[t]._u = i, ttq._t = t; if (!n || !n.f) { var o = d.createElement("script"); o.type = "text/javascript"; o.async = !0; o.src = i + "?sdkid=" + e + "&lib=" + t; var a = d.getElementsByTagName("script")[0]; a.parentNode.insertBefore(o, a) } };
      ttq.load(TIKTOK_ID);
      ttq.page();
    }(window, document, 'ttq');
  }
  ...
  function firstPartySink(event, params) {
    try {
      var payload = JSON.stringify({ event: event, props: params || {}, visitor_id: _vid, session_id: _sid, user_id: _uid, path: location.pathname, referrer: document.referrer || '' });
  ...
  window.sunamiTrack = function (event, params) {
    ...
    if (!gaOn && !ttOn && window.console && console.debug) console.debug('[sunami-track]', event, params);
  };
  ...
  /* UX layer: onboarding plus micro-interactions. Kept separate from auth/business logic. */
  try {
